...
public class ModItemRegistryHandler {
    ...
    public static final RegistryObject<Item> COPPER_PICKAXE = ITEMS.register("copper_pickaxe",() ->new PickaxeItem(ModTiers.COPPER,2,-2.4f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)){
        @Override
    ...
    public static final RegistryObject<Item> COPPER_AXE = ITEMS.register("copper_axe",() ->new AxeItem(ModTiers.COPPER,8f,-2.4f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(220)){
        @Override
        public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level world, @NotNull Entity usingEntity, int slot, boolean isSelecetd) {
            {
                //logger.debug(String.format("%d,and,%b",pSlotId,pIsSelected));
    ...
    public static final RegistryObject<Item> COPPER_SHOVEL = ITEMS.register("copper_shovel",() ->new ShovelItem(ModTiers.COPPER,4f,-2.4f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(200)){
        @Override
        public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level world, @NotNull Entity usingEntity, int slot, boolean isSelecetd) {
            {
                //logger.debug(String.format("%d,and,%b",pSlotId,pIsSelected));
    ...
    public static final RegistryObject<Item> COPPER_HOE = ITEMS.register("copper_hoe",() ->new HoeItem(ModTiers.COPPER,0,-2.4f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).durability(300)){
        @Override
        public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level world, @NotNull Entity usingEntity, int slot, boolean isSelecetd) {
            {
                //logger.debug(String.format("%d,and,%b",pSlotId,pIsSelected));
    ...
    public static final RegistryObject<Item> COPPER_HELMET = ITEMS.register("copper_helmet",() -> new ModArmorItem(ModArmorMaterials.COPPER, EquipmentSlot.HEAD,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> COPPER_CHESTPLATE = ITEMS.register("copper_chestplate",() -> new ModArmorItem(ModArmorMaterials.COPPER, EquipmentSlot.CHEST,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> COPPER_LEGGINGS = ITEMS.register("copper_leggings",() -> new ModArmorItem(ModArmorMaterials.COPPER, EquipmentSlot.LEGS,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> COPPER_BOOTS = ITEMS.register("copper_boots",() -> new ModArmorItem(ModArmorMaterials.COPPER, EquipmentSlot.FEET,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> COPPER_HORSE_ARMOR = ITEMS.register("copper_horse_armor",() -> new HorseArmorItem(4,"copper",new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> IRON_MIXED_COPPER_HELMET = ITEMS.register("iron_mixed_copper_helmet",() -> new ModArmorItem(ModArmorMaterials.IRON_MIXED_COPPER, EquipmentSlot.HEAD,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> IRON_MIXED_COPPER_CHESTPLATE = ITEMS.register("iron_mixed_copper_chestplate",() -> new ModArmorItem(ModArmorMaterials.IRON_MIXED_COPPER, EquipmentSlot.CHEST,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> IRON_MIXED_COPPER_LEGGINGS = ITEMS.register("iron_mixed_copper_leggings",() -> new ModArmorItem(ModArmorMaterials.IRON_MIXED_COPPER, EquipmentSlot.LEGS,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> IRON_MIXED_COPPER_BOOTS = ITEMS.register("iron_mixed_copper_boots",() -> new ModArmorItem(ModArmorMaterials.IRON_MIXED_COPPER, EquipmentSlot.FEET,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> ENCHANTED_COPPERY_APPLE =
            ITEMS.register("enchanted_coppery_apple",() ->new Item(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).rarity(Rarity.RARE).stacksTo(64).food(ModFoods.ENCHANTED_COPPERY_APPLE)){
                @Override
    ...
    public static final RegistryObject<Item> DERUSTING_SHOVEL =
            ITEMS.register("derusting_shovel",()->new Item(new Item.Properties().stacksTo(1).durability(3).tab(CreativeModeTab.TAB_TOOLS)));

    public static final RegistryObject<Item> COPPER_MIXED_GOLD_INGOT = ITEMS.register("copper_mixed_gold_ingot",()-> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64)));

    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_SWORD = ITEMS.register("copper_mixed_golden_sword",()-> new SwordItem(ModTiers.COPPER_MIXED_GOLD,5,-2.2f,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1)));


    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_PICKAXE = ITEMS.register("copper_mixed_golden_pickaxe",()-> new PickaxeItem(ModTiers.COPPER_MIXED_GOLD,3,-2.2f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)){
        @Override
        public boolean mineBlock(ItemStack pStack, Level pLevel, BlockState pState, BlockPos pPos, LivingEntity pEntityLiving) {
            if(!pLevel.isClientSide())
            {
    ...
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_AXE = ITEMS.register("copper_mixed_golden_axe",()-> new AxeItem(ModTiers.COPPER_MIXED_GOLD,8,-2.2f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)){
        @Override
        public boolean mineBlock(ItemStack pStack, Level pLevel, BlockState pState, BlockPos pPos, LivingEntity pEntityLiving) {
            if(!pLevel.isClientSide())
            {
    ...
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_SHOVEL = ITEMS.register("copper_mixed_golden_shovel",()-> new ShovelItem(ModTiers.COPPER_MIXED_GOLD,1.5f,-2.2f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)){
        @Override
        public boolean mineBlock(ItemStack pStack, Level pLevel, BlockState pState, BlockPos pPos, LivingEntity pEntityLiving) {
            if(!pLevel.isClientSide())
            {
    ...
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_HOE = ITEMS.register("copper_mixed_golden_hoe",()-> new HoeItem(ModTiers.COPPER_MIXED_GOLD,0,-2f,new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)){
        @Override
        public boolean mineBlock(ItemStack pStack, Level pLevel, BlockState pState, BlockPos pPos, LivingEntity pEntityLiving) {
            if(!pLevel.isClientSide())
            {
    ...
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_HELMET = ITEMS.register("copper_mixed_golden_helmet",()-> new ModArmorItem(ModArmorMaterials.COPPER_MIXED_GOLD,EquipmentSlot.HEAD,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1)));
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_CHESTPLATE = ITEMS.register("copper_mixed_golden_chestplate",()-> new ModArmorItem(ModArmorMaterials.COPPER_MIXED_GOLD,EquipmentSlot.CHEST,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1)));
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_LEGGINGS = ITEMS.register("copper_mixed_golden_leggings",()-> new ModArmorItem(ModArmorMaterials.COPPER_MIXED_GOLD,EquipmentSlot.LEGS,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1)));
    public static final RegistryObject<Item> COPPER_MIXED_GOLDEN_BOOTS = ITEMS.register("copper_mixed_golden_boots",()-> new ModArmorItem(ModArmorMaterials.COPPER_MIXED_GOLD,EquipmentSlot.FEET,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1)));

    public static final RegistryObject<Item> COPPER_NUGGET = ITEMS.register("copper_nugget",()-> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64)));

    public static final RegistryObject<Item> MATCHLOCK_GUN_AMMO = ITEMS.register("matchlock_gun_ammo", ()->new Item(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(32)));

    public static final RegistryObject<Item> MATCHLOCK_GUN = ITEMS.register("matchlock_gun", MatchlockGun::new);

    public static final RegistryObject<Item> MATCHLOCK_GUN_CHIP_EMPTY = ITEMS.register("matchlock_gun_chip_empty", ()->new Item(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(64)));
