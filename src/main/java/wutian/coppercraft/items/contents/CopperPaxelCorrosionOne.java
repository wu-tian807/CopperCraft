...
public class CopperPaxelCorrosionOne extends PaxelItem {
    public CopperPaxelCorrosionOne() {
        super(4f, -3f, ModTiers.COPPER_CORROSION_ONE, new Item.Properties().stacksTo(1).durability(260));
    }
    @Override
    public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level world, @NotNull Entity usingEntity, int slot, boolean isSelecetd) {
        ...
        Corrosion.setCorrosionToANewItem(itemStack,usingEntity,new ItemStack(ModItemRegistryHandler.COPPER_PAXEL_CORROSION_TWO.get()),slot);
