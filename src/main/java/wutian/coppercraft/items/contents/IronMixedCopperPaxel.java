...
public class IronMixedCopperPaxel extends PaxelItem {
    public IronMixedCopperPaxel() {
        super(9f, -3.2f, ModTiers.IRON_MIXED_COPPER, new Properties().stacksTo(1).tab(CreativeModeTab.TAB_TOOLS).durability(750));
    }
