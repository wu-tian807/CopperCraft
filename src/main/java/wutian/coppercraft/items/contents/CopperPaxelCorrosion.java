...
public class CopperPaxelCorrosion extends PaxelItem {

    public CopperPaxelCorrosion() {
        super(6f, -2.8f, ModTiers.COPPER_CORROSION, new Item.Properties().stacksTo(1).durability(260));
    }
    ...
    public void inventoryTick(@NotNull ItemStack itemStack, @NotNull Level world, @NotNull Entity usingEntity, int slot, boolean isSelecetd) {{
        ...
        Corrosion.setCorrosionToANewItem(itemStack,usingEntity,new ItemStack(ModItemRegistryHandler.COPPER_PAXEL_CORROSION_ONE.get()),slot);
