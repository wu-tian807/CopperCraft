...
public class CopperPaxelCorrosionTwo extends PaxelItem {
    public CopperPaxelCorrosionTwo() {
        super(3f, -3.2f, ModTiers.COPPER_CORROSION_TWO, new Properties().stacksTo(1).durability(260));
    }
