...
public class ModTiers {
    ...
    public static final ForgeTier COPPER_CORROSION_TWO = new ForgeTier(1,180,1f,0f,14, BlockTags.NEEDS_IRON_TOOL,()-> Ingredient.of(Items.COPPER_INGOT));

    public static final ForgeTier IRON_MIXED_COPPER = new ForgeTier(3,350,6.8f,0f,20, BlockTags.NEEDS_IRON_TOOL,()-> Ingredient.of(Items.COPPER_INGOT));
