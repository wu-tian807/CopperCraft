...
public class ModArmorItem extends ArmorItem {
    ...
    public boolean makesPiglinsNeutral(ItemStack stack, LivingEntity wearer) {
        return stack.getItem() instanceof ArmorItem && ((ArmorItem) stack.getItem()).getMaterial() == ArmorMaterials.GOLD || ((ArmorItem) stack.getItem()).getMaterial() == ModArmorMaterials.IRON_MIXED_COPPER;
    }
